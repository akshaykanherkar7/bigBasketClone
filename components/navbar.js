...
let footer = () => {
   ...
   <div id="socoalContainer">
       <img class="bigbasketImg" src="https://sellersupport.in/wp-content/uploads/2021/05/bigbasket.png" alt="">
       <div class="download">
            <img src="https://www.freepnglogos.com/uploads/play-store-logo-png/play-store-logo-nisi-filters-australia-11.png" alt="">
            <img class ="apple" src="https://cdn.freebiesupply.com/logos/large/2x/download-on-the-app-store-apple-logo-png-transparent.png" alt="">
        </div>
        <div id="social">
